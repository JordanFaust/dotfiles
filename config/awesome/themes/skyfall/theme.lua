...
theme.tasklist_bg_focus = nordic.color.lighten(theme.frost_3, 20)
...
theme.tasklist_bg_minimize = nordic.color.darken(theme.frost_3, 20)
...
theme.taglist_bg_focus = nordic.color.lighten(theme.frost_4, 20)
