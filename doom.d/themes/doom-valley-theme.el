...
(def-doom-theme doom-valley
  ...
  ((bg         '("#172030" nil       nil            )) ;; modified
   ...
   (base6      '("#ed6284" "#6b6b6b" "brightblack"  ))
   ...
   (grey       base5)
   (red        '("#ed6284" "#c6797e" "red"          ))
   (light-red  '("#ed6284" "#DB6E8F" "red"          ))
   (orange     '("#ff996b" "#eabe9a" "brightred"    ))
   (green      '("#00b955" "#A3B9A4" "green"        ))
   (teal       '("#00b490" "#7ea9a9" "brightgreen"  ))
   (yellow     '("#ffdd79" "#F7E3AF" "yellow"       ))
   (blue       '("#043156" "#6e94b9" "brightblue"   ))
   (dark-blue  '("#043156" "#1E6378" "blue"         ))
   ...
   (tabs-bg (if doom-valley-brighter-tabs (doom-darken base6 0.1) bg))
