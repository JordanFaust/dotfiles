  ...
  (setq-default
   ...
   '(
     ...
     (org :variables
          ...
          org-projectile-file "~/org/inbox.org")
     osx
     )
...
you should place your code here."
  ...
  ;; Remove neotree modeline
  (setq neo-mode-line-type 'none)

  ;; configure and setup modeline
  ...
  ;; Fix path for go
  (setenv "GOPATH" "/home/jfaust/ws/go")
  (setenv "GOCACHE" "/home/jfaust/ws/go/cache")
  (setenv "PATH" (concat (getenv "PATH") ":/home/jfaust/ws/go/bin"))
  (setenv "PATH" (concat (getenv "PATH") ":/usr/local/go/bin"))
  (setq exec-path (append exec-path '(":/home/jfaust/ws/go/bin")))
  ...
  (load-file "~/.spacemacs.d/eshell-config.el")

  ;; indentation config
  (setq ruby-deep-indent-paren nil)
  (setq ruby-use-smie nil)
  (setq ruby-align-to-stmt-keywords '(if begin case def))
  ;; (setq go-tab-width 8)
