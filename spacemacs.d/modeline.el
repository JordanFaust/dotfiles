...
(def-modeline-segment! helm-info
...
(defun +doom-modeline|set-default-modeline ()
  (doom-set-modeline 'main t))

(defun +doom-modeline|set-helm-modeline ()
  (with-helm-buffer
    (doom-set-modeline 'helm)))

(fset 'helm-display-mode-line #'ignore)
(add-hook 'helm-after-initialize-hook #'+doom-modeline|set-helm-modeline)
(add-hook 'helm-cleanup-hook #'+doom-modeline|set-default-modeline)
