...
function create_cache() {
  echo "creating notification card"
  local urgency
  ...
  if [[ $DUNST_ICON_PATH == "" ]]
  then
    ICON_PATH=/etc/profiles/per-user/$USER/share/icons/Papirus/128x128/apps/$DUNST_APP_NAME.svg
  else
  ...
  echo "creating log for notification: $summary"
